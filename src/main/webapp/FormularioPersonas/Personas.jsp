...
<html>
    ...
    <form action="../ControladorPersonas?accion=btnGuardar" method="post">
        <body>
            <%
                Connection con = null;
                Statement st = null;
                    ...
                    <form action="#">
                        <div class="user-details">
                            ...
                            <div class="input-box">
                                ...
                                <input class="controls" type="date" name="fecharegistro" id="fecharegistro" step="1" value="dd/mm/aaaa" required> 
                            </div>
                            <div class="input-box">
