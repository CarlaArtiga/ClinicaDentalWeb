<%-- 
    Document   : Index
    Created on : 22 nov. 2022, 16:35:38
    Author     : jose4
--%>
  ...
  <div class="container">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      ...
      <ul class="nav nav-pills">
        <li class="nav-item p-1"><a href="FormularioIngreso/Ingreso.jsp" class="nav-link active">Iniciar sesión</a></li>
        <li class="nav-item p-1"><a href="FormularioIngreso/FormularioRegistro/Registro.jsp" class="nav-link active">Registrarse</a></li>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Nuestra oficina combina tecnología de vanguardia con odontología tradicional para que podamos
            Mejorar la sonrisa de los pacientes con procedimientos conservadores y no invasivos.</p>
        </div>
      </div>
    </div>
    <div class="col">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Nuestros Especialistas altamente calificados brindan atención integral a adultos y adolescentes. Ofrecemos
            una serie de procedimientos de restauración y cosméticos, incluidas coronas y blanqueamiento dental.</p>
        </div>
      </div>
    </div>
